...
const PlatformActivity = ({ data, selectedYear, onYearChange, heading = 'Platform Activity', subheading = 'Monthly breakdown of jobs and applications' }) => {
  return (
    <div className="bg-[#FDF9EE] rounded-lg p-6 border border-[#E8E3D6]">
      ...
      <div className="w-full h-[500px]">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            <defs>
              {/* Yellowish gradient for Jobs */}
              <linearGradient id="jobsGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#FFC100" stopOpacity="0.6" />
                <stop offset="100%" stopColor="#FFC100" stopOpacity="0" />
              </linearGradient>
              
              {/* Greenish gradient for Applications */}
              <linearGradient id="applicationsGradient" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#063D2E" stopOpacity="0.6" />
                <stop offset="100%" stopColor="#063D2E" stopOpacity="0" />
              </linearGradient>
            </defs>
            <CartesianGrid
              strokeDasharray="5 5"
